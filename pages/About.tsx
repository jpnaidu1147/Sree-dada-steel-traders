  ...
  return (
    <div className="w-full pt-20 relative min-h-screen">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://lh3.googleusercontent.com/d/1CeRXNJMByb99ak6_U0plg0gL_vlXYf-K" 
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          {/* Core Values */}
          <div className="mt-20">
            <h2 className="text-3xl font-bold text-steel-800 mb-10 text-center drop-shadow-sm">Core Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: 'Integrity', text: 'Fair, transparent, and responsible operations.' },
                { title: 'Commitment', text: 'Delivering on promises without compromise.' },
                { title: 'Quality', text: 'Steel products that meet industry standards.' },
                { title: 'Innovation', text: 'Modern logistics and customer-friendly service.' }
              ].map((val, idx) => (
                <div key={idx} className="bg-white/80 backdrop-blur-sm p-6 rounded border-l-4 border-brand-blue hover:shadow-md transition-shadow">
                  <h4 className="font-bold text-xl mb-2 text-steel-900">{val.title}</h4>
                  <p className="text-steel-600 text-sm">{val.text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-24">
            <h2 className="text-3xl font-bold text-steel-800 mb-12 text-center drop-shadow-sm">Leadership & Team</h2>
